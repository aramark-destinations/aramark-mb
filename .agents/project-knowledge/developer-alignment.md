...
- [ ] OneTrust: consent controls active before any tracking scripts fire
- [ ] HotJar: loads async, separate workspace per environment
- [ ] Elastic Search: integrated for full site search and listing page filtering
- [ ] Fleeknote: consent-aware, environment-specific workspace IDs
- [ ] YouTube: responsive iframe embed, optional params (autoplay, controls)
- [ ] Emplifi: block-driven embed, async loading
- [ ] Google Maps: both simple embed and Interactive Map (API-based)
- [ ] Chatbot: async loading, enable/disable per page/property
